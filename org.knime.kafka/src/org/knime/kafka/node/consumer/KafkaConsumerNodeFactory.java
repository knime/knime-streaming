 ...
 *
 */
public final class KafkaConsumerNodeFactory extends NodeFactory<KafkaConsumerNodeModel> {

    /**
     * {@inheritDoc}
     */
    @Override
    public KafkaConsumerNodeModel createNodeModel() {
        return new KafkaConsumerNodeModel();
    }
     ...
     */
    @Override
    public NodeView<KafkaConsumerNodeModel> createNodeView(final int viewIndex,
        final KafkaConsumerNodeModel nodeModel) {
        return null;
    }
