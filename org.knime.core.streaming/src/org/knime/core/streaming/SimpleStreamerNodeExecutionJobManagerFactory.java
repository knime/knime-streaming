...
public class SimpleStreamerNodeExecutionJobManagerFactory implements NodeExecutionJobManagerFactory {
    ...
    static final String ID = SimpleStreamerNodeExecutionJobManagerFactory.class.getName();
    ...
    /** {@inheritDoc} */
    @Override
    public SimpleStreamerNodeExecutionJobManager getInstance() {
        return new SimpleStreamerNodeExecutionJobManager();
    }
