 ...
 *
 * History
 *   Jan 22, 2018 (hornm): created
 */
package org.knime.core.streaming.windowed;
...
import org.knime.core.streaming.SimpleStreamerNodeExecutionJob;

/**
 *
 * @author Martin Horn, KNIME GmbH, Konstanz Germany
 */
public class WindowedStreamingNodeExecutionJob extends NodeExecutionJob {
     ...
     * @param data
     */
    public WindowedStreamingNodeExecutionJob(final NodeContainer nc, final PortObject[] data) {
        super(nc, data);
    }
    ...
    protected NodeContainerExecutionStatus mainExecute() {
        ...
        if (!(nodeContainer instanceof SubNodeContainer)) {
            String message = "Windowed streaming execution is only available for wrapped metanodes.";
